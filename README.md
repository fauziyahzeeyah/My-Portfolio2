...
```sh
  ...
  git clone git@github.com:fauziyahzeeyah/My-Portfolio2.git
```
### Install
...
Feel free to check the [issues page](https://github.com/fauziyahzeeyah/My-Portfolio2/issues)).
...
This project is [MIT](https://github.com/fauziyahzeeyah/My-Portfolio2/blob/port-folio/LICENSE) licensed.
